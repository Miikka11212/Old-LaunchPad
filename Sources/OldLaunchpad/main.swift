...
final class LaunchpadController {
    ...
    private var showDesktopAfterClosing = false
    ...
    func showDesktop() {
        guard window != nil else { SystemDesktop.showDesktop(); return }
        showDesktopAfterClosing = true
        hide()
    }
    ...
    private func finishHiding(_ panel: OverlayWindow) {
        ...
        window = nil
        isClosing = false
        if showDesktopAfterClosing {
            showDesktopAfterClosing = false
            SystemDesktop.showDesktop()
        }
    }
}
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func installStatusItem() {
        ...
        menu.addItem(NSMenuItem(title: "Show Desktop", action: #selector(showDesktopFromMenu), keyEquivalent: ""))
        menu.addItem(.separator())
